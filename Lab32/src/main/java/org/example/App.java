...
public class App {
    ...
    public static void main(String[] args) {
        System.out.println("--- Zadanie 3.2: Odczyt i weryfikacja danych XML ---");

        // Walidacja plików XML
        System.out.println("\n1. Sprawdzanie zgodności ze schematem...");
        ...
        // Wczytanie listy wartości
        System.out.println("\n---\n3. Filtrowanie i sortowanie listy wartości:");
